      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            ...
            <LuMonitorCheck className='w-[24px] h-[24px]'/>
            </div>
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            <FaMobileAlt className='w-[24px] h-[24px]'/>
            </div>
            <h3 className="mb-2 text-xl font-bold dark:text-white">
              Mobile Integration
            </h3>
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            <TbReport className='w-[24px] h-[24px]'/>
            </div>
            <h3 className="mb-2 text-xl font-bold dark:text-white">
              Automated Reporting
            </h3>
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            <BiSolidBellRing className='w-[24px] h-[24px]'/>
            </div>
            <h3 className="mb-2 text-xl font-bold dark:text-white">
              Customizable Alerts
            </h3>
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            <BsCloudArrowUpFill className='w-[24px] h-[24px]'/>
            </div>
            <h3 className="mb-2 text-xl font-bold dark:text-white">
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            <TbDeviceMobileSearch className='w-[24px] h-[24px]'/>
            </div>
            <h3 className="mb-2 text-xl font-bold dark:text-white">
